...
export const learnTopics: LearnTopic[] = [
...

  {
    ...
    name: "Mutual Funds",
    image: mutualfunds,
    tagline: "Invest in a basket of assets without picking every stock yourself.",
    intro:
    ...
    sections: [
      {
        ...
        body: "A mutual fund collects money from investors and uses that money to buy a portfolio of investments.",
        points: [
      ...
      },
      {
        ...
        body: "A SIP lets you invest a fixed amount regularly, while a lump-sum investment puts money into a fund at one time.",
        points: [
          "Invest regularly",
      ...
      },
      {
        ...
        body: "Look at the fund category, investment objective, costs, portfolio, risk and long-term performance.",
        points: [
...

  {
    ...
    name: "Shopping",
    image: shopping,
    tagline: "Spend wisely, compare prices and avoid unnecessary debt.",
    intro:
      "Smart shopping means understanding prices, discounts, credit and your actual needs before buying.",
    sections: [
      {
        heading: "1. Needs vs wants",
        body: "Before buying something, ask whether you actually need it. Separating needs from wants helps control unnecessary spending.",
        points: [
      ...
      },
      {
        ...
        body: "A discount does not automatically mean you are saving money. Compare prices and check the final cost before purchasing.",
        points: [
      ...
      },
      {
        ...
        body: "Credit cards and buy-now-pay-later products can make purchases convenient, but they can also encourage overspending.",
        points: [
    ...
    nextSteps: [keepLearning, buyFinance, buyInsurance],
  },
...

  {
    ...
    sections: [
      {
        ...
        body: "Online work includes remote jobs, freelancing, internships and part-time opportunities. Choose work based on your skills, experience and availability.",
        points: [
      ...
      },
      {
        ...
        body: "A strong resume and professional online profile can make it easier for employers and clients to understand what you can offer.",
        points: [
      ...
      },
      {
        ...
        body: "Be careful with online jobs that promise unusually high earnings or ask you to pay money before you can start working.",
        points: [
    ...
    nextSteps: [keepLearning, buyFinance],
  },
];
